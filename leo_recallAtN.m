...
%                     end
           ...
           exp_mean_min_top = exp(-1.*(mean(Pslen_table(:,17)))*exp(-1.*mean(Pslen_table(:,18))));

           exp_mean_min_to = exp(-1.*(mean(q_width_height_0))*exp(-1.*mean(db_width_height_0)));
           exp_mean_min_to0 = exp(-1.*(mean(q_width_height_2))*exp(-1.*mean(db_width_height_2)));

           %  if exp_mean_min_top == 0
         %      exp_mean_min_top = 1;
          % end
